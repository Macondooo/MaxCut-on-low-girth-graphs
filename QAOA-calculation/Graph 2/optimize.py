...
if __name__ == '__main__':
    ...
    # gamma = np.array([[0.3817, 0.6655],[pi/2,pi/2],[pi/4,pi/4],[pi/8,pi/8],[pi/8,pi/6],[pi/8,pi/6],[pi/10,pi/5],[pi/8,pi/5],[pi/10,0],[pi/7,pi/9]])  
    # beta = np.array([[0.4960, 0.2690], [pi/2,pi/2],[pi/4,pi/4],[pi/8,pi/8],[0,pi/3],[0,pi/4],[pi/5,0],[pi/6,pi/3],[pi/10,0],[pi/3,pi/10]])  
    gamma = np.array([[0.3817, 0.6655],[pi+pi/2,pi+pi/2],[pi/4,pi+pi/4],[pi+pi/8,pi+pi/8],[pi/8,pi/6],[pi+pi/8,pi+pi/6],[pi/10,pi/5],[pi/8,pi+pi/5],[pi/10,0],[pi+pi/7,pi+pi/9]])  
